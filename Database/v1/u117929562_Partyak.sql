...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 16, 2022 at 03:09 PM
...
INSERT INTO `booking` (`booking_id`, `customer_id`, `service_id`, `event_date`, `event_type`, `noOfGuest`, `package_id`, `full_payment`, `status`) VALUES
(1, 6, 10, '2022-05-08', 'wedding', 0, 1, '0.00', 'pending'),
(2, 10, 11, '2022-05-08', 'party', 0, 2, '0.00', 'Accepted'),
(3, 6, 30, '2022-02-16', 'wedding', 0, 3, '0.00', 'pending'),
(18, 20, 30, '2022-01-20', 'Wedding', 45, 2, '0.00', 'pending'),
(19, 20, 30, '2022-01-14', 'Party', 55, 1, '0.00', 'pending'),
(23, 51, 10, '2022-01-26', 'Wedding', 100, 0, '0.00', 'pending'),
(24, 51, 30, '2022-01-18', 'Wedding', 100, 2, '0.00', 'Accepted'),
(25, 51, 30, '2022-01-13', 'Wedding', 100, 2, '0.00', 'Accepted'),
(26, 20, 30, '2022-01-14', 'Wedding', 24, 1, '0.00', 'pending'),
(27, 20, 30, '2022-01-14', 'Wedding', 24, 1, '0.00', 'pending'),
(29, 17, 30, '2022-01-20', 'Personal', 25, 2, '75000.00', 'pending');
...
(41, 'my wedding', 'Wedding', '', '2022-01-22', '2022-01-22', 'Galle', 45, 53, 0, 'Through Event Planner');
...
INSERT INTO `event_planner_event_pages` (`user_id`, `event_page_id`, `event_type`, `date`, `no_of_guests`, `image1`, `location`, `description`) VALUES
(53, 13, 'Birthday', '2022-01-19', 54, '531642982755.png', 'Jaffna', 'ok');
...
INSERT INTO `notifications` (`notification_id`, `notification_type`, `heading`, `description`, `url`, `user_id`, `notification_status`) VALUES
(1, 'new_service', 'New Service Request', 'Fly Foods have just requested to be accepted on Partyak', '', 12, 0),
(2, 'new_service', 'New Service Request', 'Freed Hotels have just requested to be accepted on Partyak', '', 12, 0);
...
(1, 30, 20, 4, 'good pivithuru', '2022-01-14 08:29:21'),
(2, 30, 16, 5, 'not goffi', '2022-01-14 08:31:58'),
(3, 30, 20, 4, 'good pivithuru', '2022-01-14 08:31:02'),
...
(17, 'chamathka98@gmail.com', '$2y$10$29ITcJweVHD1su5GjYpJm.0RukyJo4sO2s7gozAMOKMOp48xoY4By', 'customer', 'Chamathka', 'Shehani', '\"56/A\",  Karandeniya', '977942885V', 'Female', '171647437927.png'),
...
(22, 'anudiathukorala@gmail.com', '$2y$10$1G3z6.GxYj40P5H2qOSucOP9FdrHIm2COZwogC8iSJHsOGjBKciz2', 'vendor', 'Anudhi', 'Athukorala', '', '', 'Female', '0'),
...
--
ALTER TABLE `event`
  MODIFY `planning_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=42;

--
-- AUTO_INCREMENT for table `event_planner_event_pages`
--
ALTER TABLE `event_planner_event_pages`
  MODIFY `event_page_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=14;
...
--
ALTER TABLE `marketing_content`
  MODIFY `content_id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=20;
...
--
ALTER TABLE `service_preferences`
  MODIFY `preference_id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1213;
