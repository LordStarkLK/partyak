...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 27, 2022 at 01:52 AM
...
(29, 17, 30, '2022-01-20', 'Personal', 25, 2, '75000.00', 'reject', 0),
...
(61, 17, 57, '2022-03-28', 'Wedding', 25, 0, '0.00', 'pending', 0),
(62, 20, 57, '2022-03-16', 'Party', 55, 0, '0.00', 'pending', 0),
(63, 17, 30, '2022-03-30', 'Party', 100, 2, '300000.00', 'pending', 0),
(65, 17, 30, '2022-03-14', 'Wedding', 100, 1, '500000.00', 'pending', 0),
(66, 17, 57, '2022-03-22', 'Party', 55, 0, '0.00', 'pending', 166);
...
(20, 33, 'Wedding', '2022-03-09', 55, '2016478430140.jpeg', '5216482112630.jpg', '2016478430140.jpeg', '5216482112630.jpg', '2016478430140.jpeg', 'Galadari Hotel', 'Good and cool');
...
(65, 'dsa', '', 161),
(66, 'dsa', '', 161),
(67, 'Get a dresser', 'completed', 78),
(68, 'Get a dresser', 'completed', 78);
...
--
ALTER TABLE `booking`
  MODIFY `booking_id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=67;

--
-- AUTO_INCREMENT for table `event`
--
ALTER TABLE `event`
  MODIFY `planning_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=167;

--
-- AUTO_INCREMENT for table `event_planner_event_pages`
--
ALTER TABLE `event_planner_event_pages`
  MODIFY `event_page_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=38;

--
-- AUTO_INCREMENT for table `event_planner_new_note`
--
ALTER TABLE `event_planner_new_note`
  MODIFY `recom_id` int(10) NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `event_schedule_board`
  MODIFY `task_id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=69;
...
--
ALTER TABLE `notifications`
  MODIFY `notification_id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=40;
...
--
ALTER TABLE `package`
  MODIFY `package_id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=42;
...
--
ALTER TABLE `service_preferences`
  MODIFY `preference_id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1277;
