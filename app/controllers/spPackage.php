...
class SpPackage extends FrameworkPartyak
{
    ...
    public function index($service_id)
    {
        ...
        if ($_SERVER['REQUEST_METHOD'] == 'POST' && $_POST["package_id"] == "insert") {
            ...
            if ($numberOfErrors == 0) {
                //Insert data
                echo "Hi";
                $this->PackageModel->addPackageDetail($packageName, $packageDescription, $packageValidFrom, $packageValidTo, $service_id, $packageUnitprice, $packageFixedprice);
            }
        }
        ...
        if ($_SERVER['REQUEST_METHOD'] == 'POST' && $_POST["package_id"] != "insert") {
            ...
            if ($numberOfErrors == 0) {
                ...
                $this->PackageModel->updatePackageDetails($packageName, $packageDescription, $packageValidFrom, $packageValidTo, $package_id, $packageUnitprice, $packageFixedprice);
            }
        }
