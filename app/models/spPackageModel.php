...
class SpPackageModel extends Database
{
    ...
    public function addPackageDetail($packageName, $packageDescription, $packageValidFrom, $packageValidTo, $service_id, $packageUnitprice, $packageFixedprice)
    {
        ...
        $query = "INSERT INTO package(service_id, package_name, description, valid_from, valid_to, per_unit_price, fixed_price) 
        VALUES ('$service_id','$packageName', '$packageDescription' , '$packageValidFrom', '$packageValidTo' , '$packageUnitprice', '$packageFixedprice')";
    ...
    public function updatePackageDetails($packageName, $packageDescription, $packageValidFrom, $packageValidTo, $package_id, $packageUnitprice, $packageFixedprice)
    {
