            ...
            <div class="signup-container">
                    ...
                    <div class="user-details">
                        <div class="name">
                            <div class="input-box1">
                                <input type="text" placeholder="First Name" name="fname" id="fname" onfocusout="validateFname()">
              ...
              <div class="error"><?php echo $errors["address"] ?></div>
                        ...
                        <div class="input-box6">
                            <input type="password" placeholder="Password" name="password" id="password" onfocusout="validatePassword()">
                            <div class="error"><?php echo $errors["password"] ?></div>
                        </div>
                        <div class="input-box7">
                            <input type="password" placeholder="Confirm password" name="confirmPassword" id="confpassword" onfocusout="validateConfPassword()">
