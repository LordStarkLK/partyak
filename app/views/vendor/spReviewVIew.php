    ...
    <div class="home-content">
      ...
      <div class="overall-chart">
          <div class="ratingBox">
            ...
            <div class="rating-bar"><div class="box1"></div> </div>
          </div>
          <div class="ratingBox">
            <div class="name">Good</div>
            <div class="rating-bar"><div class="box2"></div> </div>
          </div>
          <div class="ratingBox">
            <div class="name">Average</div>
            <div class="rating-bar"><div class="box3"></div> </div>
          </div>
          <div class="ratingBox">
            <div class="name">Below-average</div>
            <div class="rating-bar"><div class="box4"></div> </div>
          </div>
          <div class="ratingBox">
            <div class="name">Poor</div>
            <div class="rating-bar"><div class="box5"></div> </div>
          </div>
      </div>
